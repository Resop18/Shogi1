...
public class ShogiHumanPlayerTest extends GameHumanPlayer implements View.OnClickListener, View.OnTouchListener{
    ...
    public ShogiHumanPlayerTest(String name) { super(name); }
            ...
            if(currPieces[row][col] == null) {
                if(currPieces[rowSel][colSel] != null){
                    if(currPieces[rowSel][colSel].getSelected()){
                        if(rowSel == 9){
                            game.sendAction(new ShogiDropAction(this, currPieces[row][col], rowSel, colSel, row, col));
                        }
                        game.sendAction(new ShogiMoveAction(this, currPieces[row][col], rowSel, colSel, row, col));
